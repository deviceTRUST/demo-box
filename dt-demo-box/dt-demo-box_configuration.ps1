...
.FILENAME
  dt-demo-box_configuration.ps1

.DESCRIPTION
  deviceTRUST Demo-Box configuration script. Executes and configures the deviceTRUST Demo-Box installation.
...
Write-Host ""
Write-Host " ------------------------------------------------------------------------------------------"
Write-Host " | deviceTRUST Demo-Box configuration script                                              |"
Write-Host " ------------------------------------------------------------------------------------------"
Write-Host ""
